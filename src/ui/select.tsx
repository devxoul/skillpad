...
export const SelectTrigger = forwardRef<HTMLButtonElement, ComponentPropsWithoutRef<typeof BaseSelect.Trigger>>(
...
export const SelectIcon = forwardRef<HTMLSpanElement, ComponentPropsWithoutRef<typeof BaseSelect.Icon>>(
  ({ className, children, ...props }, ref) => (
...
export const SelectPositioner = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Positioner>>(
  ({ className, ...props }, ref) => (
    <BaseSelect.Positioner ref={ref} className={clsx('z-50 outline-none', className)} sideOffset={8} {...props} />
  ),
)
SelectPositioner.displayName = 'SelectPositioner'

export const SelectPopup = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Popup>>(
  ({ className, ...props }, ref) => (
    <BaseSelect.Popup
      ref={ref}
      className={clsx(
...
export const SelectItem = forwardRef<HTMLDivElement, ComponentPropsWithoutRef<typeof BaseSelect.Item>>(
  ({ className, children, ...props }, ref) => (
    <BaseSelect.Item
      ref={ref}
      className={clsx(
