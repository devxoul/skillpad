...
export const fr = {
  ...
  gallery_repo_search_section: 'Trouvés sur GitHub',
  ...
  preferences_check_for_update: 'Rechercher des mises à jour',
  preferences_up_to_date: 'À jour',
  ...
  selection_count_one: '{count} skill sélectionné',
  selection_count_other: '{count} skills sélectionnés',
